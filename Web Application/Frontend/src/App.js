  ...
  return (
    ...
    <div>
      <CCard style={{ width: '18rem'}}>
        ...
        <CCardBody>Model 1: A model that uses family-related attributes to predict violent crime. <br></br> Model 2: A model that uses wealth-related attributes to predict violent crime. <br></br> Model 3: A model that uses race-related attributes to predict violent crime. <br></br> Model 4: A model that uses all of the above attributes to predict violent crime.</CCardBody>
      </CCard>
      </div>
    </div>      
  );
